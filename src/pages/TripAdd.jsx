...
export default function TripAdd() {
    ...
    function handleButton() {
        ...
        axios
    .post("http://localhost:8081/trip?takeoff="+takeOff+"&destination="+destination+"&takeOffTime="+currentDate+"&returnTime="+currentDateTwo+"&price="+price)
    .then((response) => {
        ...
        <div>
            <Card centered >
                ...
                <Form>
                    ...
                    <br /><br />
                    <SemanticDatepicker inverted onChange={onChangeTwo} />
                    <br /><br />
